...
setup_menu_t keys_settings1[] =  // Key Binding screen strings       
{
  ...
  {"FIRE"        ,S_KEY       ,m_scrn,KB_X,KB_Y+5*8,{&key_fire},&mousebfire,&joybfire},
  {"USE"         ,S_KEY       ,m_scrn,KB_X,KB_Y+6*8,{&key_use},&mousebforward,&joybuse},
  {"STRAFE LEFT" ,S_KEY       ,m_scrn,KB_X,KB_Y+7*8,{&key_strafeleft},0,&joybstrafeleft},
  {"STRAFE RIGHT",S_KEY       ,m_scrn,KB_X,KB_Y+8*8,{&key_straferight},0,&joybstraferight},
  {"RUN"         ,S_KEY       ,m_scrn,KB_X,KB_Y+9*8,{&key_speed},0,&joybspeed},
  {"STRAFE"      ,S_KEY       ,m_scrn,KB_X,KB_Y+10*8,{&key_strafe},&mousebstrafe,&joybstrafe},
  {"AUTORUN"     ,S_KEY       ,m_scrn,KB_X,KB_Y+11*8,{&key_autorun}},
  {"180 TURN"    ,S_KEY       ,m_scrn,KB_X,KB_Y+12*8,{&key_reverse}},

  {"GAME"        ,S_SKIP|S_TITLE,m_null,KB_X,KB_Y+13*8},
  {"SAVE"        ,S_KEY       ,m_scrn,KB_X,KB_Y+14*8,{&key_savegame}},
  {"LOAD"        ,S_KEY       ,m_scrn,KB_X,KB_Y+15*8,{&key_loadgame}},
  {"QUICKSAVE"   ,S_KEY       ,m_scrn,KB_X,KB_Y+16*8,{&key_quicksave}},
  {"QUICKLOAD"   ,S_KEY       ,m_scrn,KB_X,KB_Y+17*8,{&key_quickload}},
  {"END GAME"    ,S_KEY       ,m_scrn,KB_X,KB_Y+18*8,{&key_endgame}},
...
setup_menu_t keys_settings3[] =  // Key Binding screen strings       
{
  ...
  {"QUIT"        ,S_KEY       ,m_scrn,KB_X,KB_Y+11*8,{&key_quit}},
...
setup_menu_t keys_settings2[] =  // Key Binding screen strings       
{
  ...
  {"Enable Fist/Chainsaw\n& SG/SSG toggle", S_YESNO, m_null, KB_X,
   KB_Y+14*8, {"doom_weapon_toggles"}},
